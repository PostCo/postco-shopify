...
n.innerHTML=s.innerHTML||s.xml||e,"undefined"==typeof jQuery&&$.getScript("https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.0/jquery.min.js").done(function(e,t){console.log("jQuery loaded")}).fail(function(e,t,n){console.log("jQuery failed to load")}),$.getScript("https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.12.1/js/standalone/selectize.min.js").done(function(e,t){initializeSelectize()}).fail(function(e,t,n){console.log("Selectize failed to load")}),$.getScript("https://cdnjs.cloudflare.com/ajax/libs/remodal/1.1.0/remodal.min.js").done(function(e,t){initializeRemodal()}).fail(function(e,t,n){console.log("Remodal failed to load")})}else console.log("inject - no body tag found.")}},r="data-pc-src",c="/plugins/v1/shopify",d=function(t){var n=t.getAttribute(r)+c
