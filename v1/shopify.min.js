"use strict"
jQuery.loadScript=function(t,e){return e=$.extend(e||{},{dataType:"script",cache:!0,url:t}),jQuery.ajax(e)},$.loadScript("https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.12.1/js/standalone/selectize.min.js")(function(){var t=function(){var t="https:"===window.location.protocol?"https:":"http:",e="//query.yahooapis.com/v1/public/yql?q=",n=encodeURIComponent("select * from html where url = ")
...
n.innerHTML=i.innerHTML||i.xml||t,$.loadScript("https://cdnjs.cloudflare.com/ajax/libs/remodal/1.1.0/remodal.min.js").done(function(t,e){initializeRemodal()})}else console.log("inject - no body tag found.")}},s="data-pc-src",c=function(e){var n=e.getAttribute(s)
