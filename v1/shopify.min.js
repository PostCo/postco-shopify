"use strict"
!function(){if(document.head.insertAdjacentHTML("beforeend",'<link rel="stylesheet" type="text/css" href="https://cdn.rawgit.com/PostCo/postco-shopify/v1.7.14/v1/shopify.min.css">'),void 0===window.jQuery){var t=document.createElement("script")
...
return e}}(),r=function(t,e,n){for(var o=t.getElementsByTagName(n),s=0,i=o.length;s<i;s++)e.push(o[s])
return e},a=function(t,e){var o=n(t)
if(null!==o){var s=o.getElementsByTagName("body")
if(1===s.length){var i=s[0],a=[]
a=r(o,a,"script"),a=r(o,a,"style")
for(var c=0,d=a.length;c<d;c++)a[c].parentNode.removeChild(a[c])
e.innerHTML=i.innerHTML||i.xml||t,$.getScript("https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.12.1/js/standalone/selectize.min.js").done(function(t,e){initializeSelectize()}).fail(function(t,e,n){console.log("Selectize failed to load")}),$("#js-postco-shipping").click()}else console.log("inject - no body tag found.")}},c="data-pc-src",d="/plugins/v1/shopify",u=function(t){var n=t.getAttribute(c)+d
