...
return"undefined"!=typeof XMLHttpRequest&&e()?t=function(){return new XMLHttpRequest}:"undefined"!=typeof XDomainRequest?t=function(){return new XDomainRequest}:console.log("inject - cors isn't supported."),t}(),a=function(e,t){var n=o()
...
return t}}(),i=function(e,t,n){for(var o=e.getElementsByTagName(n),a=0,r=o.length;a<r;a++)t.push(o[a])
return t},s=function(e,t){var o=n(e)
if(null!==o){var a=o.getElementsByTagName("body")
if(1===a.length){var r=a[0],s=[]
s=i(o,s,"script"),s=i(o,s,"style")
for(var c=0,d=s.length;c<d;c++)s[c].parentNode.removeChild(s[c])
t.innerHTML=r.innerHTML||r.xml||e,$.getScript("https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.12.1/js/standalone/selectize.min.js").done(function(e,t){initializeSelectize()}).fail(function(e,t,n){console.log("Selectize failed to load")}),$.getScript("https://cdnjs.cloudflare.com/ajax/libs/remodal/1.1.0/remodal.min.js").done(function(e,t){$(".remodal").remodal()}).fail(function(e,t,n){console.log("Remodal failed to load")})}else console.log("inject - no body tag found.")}},c="data-pc-src",d="/plugins/v1/shopify",l=function(e){var n=e.getAttribute(c)+d
a(t(n),function(t){s(t,e)})}
setTimeout(function(){for(var e=r(c),t=0,n=e.length;t<n;t++)l(e[t])},0)}()
...
$("form.cart").attr("action","cart?"+a)},load:function(e,o){this.settings.load=null,$.ajax({url:n+"/api/v1/locations",xhrFields:{withCredentials:!0},headers:{Authorization:"Bearer "+t},type:"GET",error:function(){o()},success:function(e){var t=e.data.map(function(e){return{id:e.attributes["agent-id"],name:e.attributes.company,address1:e.attributes.address1,address2:e.attributes.address2,city:e.attributes.city,zip:e.attributes.zip,province:e.attributes.state,country:e.attributes.country}})
o(t)}})}})}
