"use strict"
!function(){if(document.head.insertAdjacentHTML("beforeend",'<link rel="stylesheet" type="text/css" href="https://cdn.rawgit.com/PostCo/postco-shopify/v1.7.9/v1/shopify.min.css">'),void 0===window.jQuery){var t=document.createElement("script")
...
return"undefined"!=typeof XMLHttpRequest&&t()?e=function(){return new XMLHttpRequest}:"undefined"!=typeof XDomainRequest?e=function(){return new XDomainRequest}:console.log("inject - cors isn't supported."),e}(),i=function(t,e){var n=o()
...
return e}}(),a=function(t,e,n){for(var o=t.getElementsByTagName(n),i=0,r=o.length;i<r;i++)e.push(o[i])
...
e.innerHTML=r.innerHTML||r.xml||t,$.getScript("https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.12.1/js/standalone/selectize.min.js").done(function(t,e){initializeSelectize()}).fail(function(t,e,n){console.log("Selectize failed to load")})}else console.log("inject - no body tag found.")}},c="data-pc-src",d="/plugins/v1/shopify",u=function(t){var n=t.getAttribute(c)+d
i(e(n),function(e){s(e,t)})}
