...
n.innerHTML=r.innerHTML||r.xml||t,initializeSelectize(),initializeRemodal()}else console.log("inject - no body tag found.")}},s="data-pc-src",c=function(e){var n=e.getAttribute(s)
o(t(n),function(t){r(t,e)})}
setTimeout(function(){for(var t=i(s),e=0,n=t.length;e<n;e++)c(t[e])},0)}()
var initializeRemodal=function(){$(".remodal").remodal()},initializeSelectize=function(){console.log("PC-PLUGIN initialized!")
