"use strict"
!function(){document.head.insertAdjacentHTML("beforeend",'<link rel="stylesheet" type="text/css" href="https://rawgit.com/PostCo/postco-shopify/master/v1/shopify.min.css">')
var t=function(){var t="https:"===window.location.protocol?"https:":"http:",e="//query.yahooapis.com/v1/public/yql?q=",n=encodeURIComponent("select * from html where url = ")
...
n.innerHTML=r.innerHTML||r.xml||t,$.getScript("https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.12.1/js/standalone/selectize.min.js").done(function(t,e){initializeSelectize()}).fail(function(t,e,n){console.log("Selectize failed to load")}),$.getScript("https://cdnjs.cloudflare.com/ajax/libs/remodal/1.1.0/remodal.min.js").done(function(t,e){initializeRemodal()}).fail(function(t,e,n){console.log("Remodal failed to load")})}else console.log("inject - no body tag found.")}},s="data-pc-src",c="/plugins/v1/shopify",d=function(e){var n=e.getAttribute(s)+c
