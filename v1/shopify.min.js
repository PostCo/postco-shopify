"use strict"
!function(){document.head.insertAdjacentHTML("beforeend",'<link rel="stylesheet" type="text/css" href="https://rawgit.com/PostCo/postco-shopify/master/v1/shopify.min.css">'),document.head.insertAdjacentHTML("beforeend",'<link rel="stylesheet" type="text/css" href="https://rawgit.com/PostCo/postco-shopify/master/v1/shopify.min.css">')
var e=function(){var e="https:"===window.location.protocol?"https:":"http:",t="//query.yahooapis.com/v1/public/yql?q=",n=encodeURIComponent("select * from html where url = ")
return function(o){return e+t+n+"%27"+encodeURIComponent(o)+"%27"}}(),t=function(){return"undefined"!=typeof window.DOMParser?function(e){return(new DOMParser).parseFromString(e,"text/xml")}:"undefined"!=typeof ActiveXObject&&new ActiveXObject("Microsoft.XMLDOM")?function(e){var t=new ActiveXObject("Microsoft.XMLDOM")
return t.async="false",t.loadXML(e),t}:(console.log("inject - no xml parser found."),function(e){return null})}(),n=function(){function e(){var e=new XMLHttpRequest
return"withCredentials"in e}var t=null
return"undefined"!=typeof XMLHttpRequest&&e()?t=function(){return new XMLHttpRequest}:"undefined"!=typeof XDomainRequest?t=function(){return new XDomainRequest}:console.log("inject - cors isn't supported."),t}(),o=function(e,t){var o=n()
null!==o&&(o.open("GET",e,!0),o.onerror=function(){console.log("inject - error making a request for a source's HTML.")},o.onload=function(){t(o.responseText)},o.send(null))},i=function(){return"undefined"!=typeof document.querySelectorAll?function(e){return document.querySelectorAll("["+e+"]")}:function(e){for(var t=[],n=document.getElementsByTagName("*"),o=0,i=n.length;o<i;o++)null!==n[o].getAttribute(e)&&t.push(n[o])
return t}}(),a=function(e,t,n){for(var o=e.getElementsByTagName(n),i=0,a=o.length;i<a;i++)t.push(o[i])
return t},s=function(e,n){var o=t(e)
if(null!==o){var i=o.getElementsByTagName("body")
if(1===i.length){var s=i[0],r=[]
r=a(o,r,"script"),r=a(o,r,"style")
for(var c=0,d=r.length;c<d;c++)r[c].parentNode.removeChild(r[c])
n.innerHTML=s.innerHTML||s.xml||e,"undefined"==typeof jQuery?$.getScript("https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.0/jquery.min.js").done(function(e,t){console.log("jQuery loaded")}).fail(function(e,t,n){console.log("jQuery failed to load")}):console.log("jQuery is already loaded"),$.getScript("https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.12.1/js/standalone/selectize.min.js").done(function(e,t){initializeSelectize()}).fail(function(e,t,n){console.log("Selectize failed to load")}),$.getScript("https://cdnjs.cloudflare.com/ajax/libs/remodal/1.1.0/remodal.min.js").done(function(e,t){initializeRemodal()}).fail(function(e,t,n){console.log("Remodal failed to load")})}else console.log("inject - no body tag found.")}},r="data-pc-src",c="/plugins/v1/shopify",d=function(t){var n=t.getAttribute(r)+c
o(e(n),function(e){s(e,t)})}
setTimeout(function(){for(var e=i(r),t=0,n=e.length;t<n;t++)d(e[t])},0)}()
