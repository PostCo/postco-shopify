"use strict"
jQuery.loadScript=function(t,e){return e=$.extend(e||{},{dataType:"script",cache:!0,url:t}),jQuery.ajax(e)},function(){var t=function(){var t="https:"===window.location.protocol?"https:":"http:",e="//query.yahooapis.com/v1/public/yql?q=",n=encodeURIComponent("select * from html where url = ")
...
return e}}(),a=function(t,e,n){for(var o=t.getElementsByTagName(n),r=0,a=o.length;r<a;r++)e.push(o[r])
...
setTimeout(function(){for(var t=r(s),e=0,n=t.length;e<n;e++)c(t[e])},0)}()
var initializeRemodal=function(){jQuery.loadScript("https://"),$(".remodal").remodal()},initializeSelectize=function(){jQuery.loadScript("https://cdnjs.cloudflare.com/ajax/libs/remodal/1.1.0/remodal.min.js")
var t=document.getElementById("postco-plugin"),e=t.dataset.pcApi,n=t.dataset.pcEnv,o="dev"===n?"https://postco.xyz":"https://postco.com.my"
