...
(function () {
  /* Inject the css. */
  document.head.insertAdjacentHTML( 'beforeend', '<link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/gh/PostCo/postco-shopify@v1.7.18/v1/shopify.min.css">' );
